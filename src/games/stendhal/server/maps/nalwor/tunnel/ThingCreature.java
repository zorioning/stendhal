...
/**
 * Configure Drow Tunnel -1 to include a Thing Creature who carries an .
...
public class ThingCreature implements ZoneConfigurator {
	...
	private void buildDrowTunnelArea(final StendhalRPZone zone) {
		...
		final Creature creature = new ItemGuardCreature(manager.getCreature("thing"), "护身符", "kill_dark_elves", null);
