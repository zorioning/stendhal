	...
	private void buildNPC(final StendhalRPZone zone) {
		final SpeakerNPC npc = new SpeakerNPC("Hank") {
			...
			protected void createDialog() {
		        ...
		        addReply(Arrays.asList("塞门镇", "塞门镇", "City"),
		        		"It was a nice place to live, but nothing exciting happens there. Here in Ados it is different, it's a huge city.");
		        addReply("mine", "The 塞门镇 mine is quite old, there are places you better not go to. In the area near the entrance it's relatively safe but the #other #miners and I heard strange noises from the deeper tunnels... Many are blocked now, but nobody knows what is #haunting down there...");
