	...
	private void buildNPC(StendhalRPZone zone) {
		SpeakerNPC npc = new SpeakerNPC("Jenny") {
			...
			public void createDialog() {
				addJob("我管理着这个风车，用它把农民生产的谷物 #grain 磨 #mill 成面粉，我也为 Semos 的面包房供货.");
				addReply("grain",
				        "附近是个农场；经常有一些人在那里收割农作物。要收获农作物，当然需要一把镰刀.");
				addHelp("你知道 Semos 的面包房？自豪的说他们用的是我的面粉，但最近狼群又咬了我的运货员... 他们可能被吓跑了.");
				addGoodbye();
				...
				addReply("plant","种子应该种在肥沃的土地上。只要找找 Semos 平原 到 arandula 的道路经过的地方，种子都可以在那里长的很好，你可以每天看看花儿生长的情况。当花儿长成时，就能被采摘了。这些地区对每个人开放，所以每个人都有机会得到你种的花，不好好在这些种子很便宜!");
			}
