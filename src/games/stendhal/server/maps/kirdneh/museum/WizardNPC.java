	...
	private void buildNPC(final StendhalRPZone zone) {
		final SpeakerNPC npc = new SpeakerNPC("Kampusch") {
			...
			@Override
				...
				addReply("mithril", "Should you need it, I can #fuse 密银矿石s and silk thread together. But I don't perform this magic for just anyone... Once you have the mithril thread, it can be woven into fabric by #Whiggins.");
				addGoodbye("Farewell.");
