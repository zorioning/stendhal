	...
	private void buildNPC(final StendhalRPZone zone) {
		final SpeakerNPC npc = new SpeakerNPC("Kampusch") {
			...
			@Override
				...
				addReply("thread", "The best thread of all is light and strong, it is called #silk and it comes from the 蜘蛛丝腺s of spiders. Making the thread from the glands is a job which is messy. Wizards will not stoop so low. #Scientists are most likely to make thread if you need it.");
				addReply("fabric", "Cloth has different standards, which I'm sure you'll notice in your own cloaks. #密银布 is the very finest and strongest of all. But then, I would say that, being from Mithrilbourgh... So, you need to find plenty of 蜘蛛丝腺s, then take them to a #scientist to make the thread. Once you have 丝线 bring it to me to #fuse mithril into it. Finally, you will need to take the 密银线 to #Whiggins to get the fabric woven.");
				addReply("mithril", "Should you need it, I can #fuse 密银矿石s and 丝线 together. But I don't perform this magic for just anyone... Once you have the 密银线, it can be woven into fabric by #Whiggins.");
				addGoodbye("Farewell.");
