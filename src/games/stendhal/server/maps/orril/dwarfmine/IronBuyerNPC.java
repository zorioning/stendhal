	...
	private void buildDwarfMineArea(final StendhalRPZone zone) {
		...
		final SpeakerNPC loretta = new SpeakerNPC("Loretta") {
			...
			protected void createDialog() {
				addGreeting();
				addJob("I'm the supervisor responsible for maintaining the mine-cart rails in this mine. But, ironically, we ran out of cast 铁锭 to fix them with! Maybe you can #offer me some?");
