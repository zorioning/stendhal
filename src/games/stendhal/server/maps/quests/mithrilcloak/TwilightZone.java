...
class TwilightZone {
	...
	private void getMossStep() {
		...
		npc.add(ConversationStates.ANY,
				Arrays.asList("moss", "magical", "twilight", "ida", "斗蓬", "密银斗篷", "specials", "暮光苔藓"),
	...
	private void twilightZoneStep() {
		...
		npc.add(ConversationStates.ATTENDING,
				Arrays.asList("magical", "mithril", "斗蓬", "密银斗篷", "task", "quest", "twilight"),
				new QuestInStateCondition(mithrilcloak.getQuestSlot(), "twilight_zone"),
				ConversationStates.ATTENDING,
		...
		npc.add(ConversationStates.ATTENDING,
				Arrays.asList("magical", "mithril", "斗蓬", "密银斗篷", "task", "quest", "twilight", "elixir"),
