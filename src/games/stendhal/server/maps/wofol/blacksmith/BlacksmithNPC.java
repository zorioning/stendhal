	...
	private void buildBlacksmith(final StendhalRPZone zone) {
		final SpeakerNPC dwarf = new SpeakerNPC("Alrak") {
			...
			protected void createDialog() {
				addGreeting("How did you get down here? I usually only see #狗头人s.");
				addJob("I am a blacksmith. I was a 山地矮人 but I left that lot behind me. Good riddance, I say!");
				...
				addReply("狗头人s", "You know, those odd furry creatures. Don't get much conversation out of any except #Wrvil.");
