	...
	private void buildNPC(final StendhalRPZone zone) {
		final SpeakerNPC princessNPC = new SpeakerNPC("Princess Ylflia") {
			...
			protected void createDialog() {
				...
				addJob("I am the princess of this kingdom. To become one of my citizens, speak to 巴瑞特霍木斯 in the city. He may be able to sell you a house. But first, I have a #favour to ask of you...");
