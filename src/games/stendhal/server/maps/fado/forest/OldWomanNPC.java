...
/**
 * Creates Jefs mother 安伯 in Fado Forest and other areas (she moves in different zones)
 *
...
public class OldWomanNPC implements ZoneConfigurator {
	...
	private void buildNPC(final StendhalRPZone zone) {
		final SpeakerNPC npc = new SpeakerNPC("安伯") {
			...
			protected void createDialog() {
				...
				addReply("problem", "I fell in love with a man in Kirdneh called 罗格费雷普顿. Unfortunetly we broke up and I didn't know what to do after so I went out of the city and spent some time on my #own here.");
