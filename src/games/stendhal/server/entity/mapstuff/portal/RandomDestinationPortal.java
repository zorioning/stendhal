...
public class RandomDestinationPortal extends QuestCompletedPortal {
	...
	private void initLocations() {
		locations.add(new Location("0_塞门_山_n_w2", 10, 65, 116));	// gnome village
		locations.add(new Location("0_阿多斯_郊外_nw", 10, 52, 39)); 		// ados zoo
		...
		locations.add(new Location("-1_阿多斯_废弃_要塞", 90, 3, 103));  // abandoned keep
		...
		locations.add(new Location("-1_阿多斯_郊外_w", 200, 33, 30)); 		// -1 ados wall
