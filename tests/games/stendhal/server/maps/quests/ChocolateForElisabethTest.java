...
public class ChocolateForElisabethTest extends ZonePlayerAndNPCTestImpl {
	...
	private static final String ELISABETH = "伊丽莎白";
	private static final String ZONE_NAME = "0_kirdneh_city";

	private static final String CHOCOLATE = "巧克力棒";
	...
	private static final String LIZ_TALK_QUEST_OFFER_AGAIN = "I hope another 巧克力棒 wouldn't be greedy. Can you get me another one?";
	...
	private static final String MUM_TALK_GREET_AND_APPROVE = "Oh you met my daughter 伊丽莎白 already. You seem like a nice person so it would be really kind, if you can bring her a 巧克力棒 because I'm not #strong enough for that.";

	private static final String HISTORY_DEFAULT = "伊丽莎白 is a sweet little girl who lives in Kirdneh together with her family.";
	private static final String HISTORY_REJECTED = "I don't like sweet little girls.";
	private static final String HISTORY_START = "Little 伊丽莎白 wants a 巧克力棒.";
	private static final String HISTORY_GOT_CHOCOLATE = "I found a tasty 巧克力棒 for 伊丽莎白.";
	private static final String HISTORY_MUM_APPROVES = "I spoke to Carey, 伊丽莎白's mom and she agreed I could give a 巧克力棒 to her daughter.";
	private static final String HISTORY_DONE = "伊丽莎白 is eating the 巧克力棒 I gave her, and she gave me some flowers in return.";
	private static final String HISTORY_REPEATABLE = "I took some chocolate to 伊丽莎白, she gave me some flowers in return. Perhaps she'd like more chocolate now.";
	...
	public void testAcceptQuest() {
		String responseToGreeting = startTalkingToNpc(伊丽莎白);
