...
public class StuffForBaldemarTest extends ZonePlayerAndNPCTestImpl {
	...
	public void testAcceptQuest() {
		String neededItems = "20 密银锭s, an obsidian, a 钻石, 5 emeralds, 10 carbuncles, 10 sapphires, a black shield, a magic plate shield, 10 金条s, 20 pieces of iron, 10 黑珍珠, 20 忍者镖s, 15 玻璃球 and a 雪晶球";
	...
	public void testBroughtNotEnoughMithrilBars() {
		...
		assertEquals("I cannot #forge it without the missing 15 密银锭s. After all, this IS a mithril shield.", getReply(baldemar));
		String neededItems = "15 密银锭s, an obsidian, a 钻石, 5 emeralds, 10 carbuncles, 10 sapphires, a black shield, a magic plate shield, 10 金条s, 20 pieces of iron, 10 黑珍珠, 20 忍者镖s, 15 玻璃球 and a 雪晶球";
		assertHistory(HISTORY_DEFAULT, HISTORY_START, HISTORY_NEED_ITEMS_PREFIX + neededItems + HISTORY_NEED_ITEMS_SUFFIX);
	}
	...
	public void testBroughtObsidian() {
		...
		en.step(player, "hi");
		assertEquals("I need several gems to grind into dust to mix with the mithril. I need a 钻石 still.", getReply(baldemar));
	}

	@Test
	public void testBrought钻石AndNotEnoughEmeralds() {
		en.setCurrentState(ConversationStates.IDLE);
	...
	public void testBroughtMagicPlateShield() {
		...
		en.step(player, "hi");
		assertEquals("I need 9 金条s to melt down with the mithril and iron.", getReply(baldemar));
	}
	...
	public void testBroughtIronBarsAndNotEnoughPearls() {
		...
		en.step(player, "hi");
		assertEquals("I need 9 黑珍珠 to crush into fine powder to sprinkle onto shield to give it a nice sheen.", getReply(baldemar));
	}
	...
	public void testBroughtBlackPearlsAndNotEnoughShurikens() {
		...
		en.step(player, "hi");
		assertEquals("I need 19 忍者镖s to melt down with the mithril, gold and iron. It is a 'secret' ingredient that only you and I know about. ;)", getReply(baldemar));
	}
	...
	public void testBroughtMarbles() {
		...
		en.step(player, "hi");
		assertEquals("I just LOVE those trinkets from Athor. I need a 雪晶球 still.", getReply(baldemar));

		String neededItems = "a 雪晶球";
	...
	public void testItemsAllUpToBlackShield() {
		...
		PlayerTestHelper.equipWithStackableItem(player, "密银锭", 20);
		PlayerTestHelper.equipWithItem(player, "obsidian");
		PlayerTestHelper.equipWithItem(player, "钻石");
	...
	public void testItemsAllAfterBlackShield() {
		...
		PlayerTestHelper.equipWithItem(player, "雪晶球");
	...
	public void testAskToForgeWithoutAnyItem() {
		...
		assertEquals("I need 20 密银锭s, an obsidian, a 钻石, 5 emeralds, 10 carbuncles, 10 sapphires, a black shield, a magic plate shield, 10 金条s, 20 pieces of iron, 10 黑珍珠, 20 忍者镖s, 15 玻璃球 and a 雪晶球.", getReply(baldemar));
	}
	...
	public void testAskToForgeWithoutLastThreeItems() {
		...
		assertEquals("I need 10 忍者镖s, 15 玻璃球 and a 雪晶球.", getReply(baldemar));
	}
	...
	public void testAskToForgeWithoutLastTwoItems() {
		...
		assertEquals("I need 3 玻璃球 and a 雪晶球.", getReply(baldemar));
	}
	...
	public void testAskToForgeWithoutLastItem() {
		...
		assertEquals("I need a 雪晶球.", getReply(baldemar));
	}
