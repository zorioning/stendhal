...
public class SadScientistTest {
	...
	public void testQuest() {
		...
		en.step(player, "vera");
		assertEquals("What? How do you know her? Well it is a sad story. She was picking 海芋 for 伊丽莎 (they were friends) and she saw the catacombs entrance. 3 months later a young hero saw her, and she was a 吸血女郎. What a sad story. I kept this for her husband. A letter. I think he is in Kalavan.", getReply(npc));
		en.step(player, "bye");
