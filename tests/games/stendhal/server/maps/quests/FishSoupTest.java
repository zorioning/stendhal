...
public class FishSoupTest {
	...
	public void testQuest() {
		...
		assertEquals("I need 11 ingredients before I make the soup: #surgeonfish, #cod, #char, #roach, #clownfish, #onion, #mackerel, #大蒜, #韭菜, #perch, and #西红柿. Will you collect them?", getReply(npc));
		en.step(player, "no");
