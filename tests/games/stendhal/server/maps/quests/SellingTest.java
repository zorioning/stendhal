...
public class SellingTest extends ZonePlayerAndNPCTestImpl {
	...
	private static final String ZONE_NAME = "int_阿多斯_酒吧";
	...
	public void testSelling() {
		...
		assertEquals("I buy pieces of cheese, pieces of meat, 菠菜es, pieces of ham, sacks of flour, and porcini.", getReply(npc));
