...
public class HouseKeyTest {
	...
	public void testCopy() {
		final HouseKey key = (HouseKey) SingletonRepository.getEntityManager().getItem("房间钥匙");
	...
	public void testDescription() {
		...
		key.setup("outhouse", 13, "税官");
		assertEquals(key.describe(), "You see a key to 税官's property, outhouse.");
	}
